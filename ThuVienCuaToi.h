...
int const KI_TU_KHOANG_TRANG_TRONG_ASCII = 32;
int const KI_TU_A_TRONG_ASCII = 65;
int const KI_TU_Z_TRONG_ASCII = 90;
int const KI_TU_a_TRONG_ASCII = 97;
int const KI_TU_z_TRONG_ASCII = 122;
